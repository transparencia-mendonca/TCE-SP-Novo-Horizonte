...
const DBN="tcesp-novo-horizonte-v6",STORE="dados",KEY="base";
...
(async()=>{
  ...
  try{
    ...
    if(!hasUsableData(db)){
      let old=null;
      try{
        let raw=localStorage.getItem("tcesp-novo-horizonte-data")||localStorage.getItem("tcesp-data");
    ...
    try{
      await save();
      localStorage.removeItem("tcesp-novo-horizonte-data");
    }catch(e){
      initError=e;
